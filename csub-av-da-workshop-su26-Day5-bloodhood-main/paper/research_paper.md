...
Stroke is one of the most devastating neurological emergencies worldwide, ranking as the second leading cause of death globally and the leading cause of long-term disability. Each year, approximately 15 million people suffer a stroke, of whom 6.2 million die and another 5 million are left permanently disabled [7]. In the United States alone, a stroke occurs every 40 seconds, resulting in roughly 795,000 events annually and economic costs exceeding $34 billion [6]. Strokes are classified into two primary types: ischemic stroke (approximately 87% of cases), caused by blockage of a cerebral artery due to thrombosis or embolism, and hemorrhagic stroke, caused by the rupture of a blood vessel within the brain. Despite this burden, clinical evidence indicates that up to 80% of strokes are preventable through timely identification and management of modifiable risk factors such as hypertension, hyperglycemia, atrial fibrillation, smoking, and obesity.

This study applies statistical data analytics to a clinical stroke dataset of 5,110 patients to identify which demographic and medical factors most strongly predict stroke occurrence. Using Independent Samples T-Tests, One-Way ANOVA, Chi-Square tests of independence, Quartile Analysis, and Patient Segmentation, we quantify the contribution of age, hypertension, heart disease, average glucose level, BMI, and lifestyle factors to stroke risk. Results show that age (mean 67.7 vs. 41.9 years in non-stroke patients; *p* < 0.0001), hypertension (3.3× elevated risk), heart disease (~4× elevated risk), and hyperglycemia (mean glucose 132.5 vs. 104.8 mg/dL; *p* < 0.0001) are the strongest independent predictors. A novel 5-factor composite risk score successfully stratifies patients into a high-risk subgroup with an 18.24% stroke rate — 3.7 times the population average of 4.87%. These findings support the development of simple, interpretable risk stratification tools deployable in primary care settings for early stroke prevention.
