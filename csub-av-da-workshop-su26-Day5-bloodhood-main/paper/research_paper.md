...
## Abstract
This study investigates the clinical and demographic factors associated with stroke risk using a dataset of 5,110 patients from Kaggle. Applying T-Tests, ANOVA, Chi-Square tests, Quartile Analysis, and Patient Segmentation, we identify age, hypertension, heart disease, and glucose level as the most statistically significant predictors of stroke. A 5-factor composite risk score successfully identifies a high-risk subgroup with a stroke rate of 18.24% — 3.7 times the population average. We conclude with actionable clinical recommendations for targeted stroke prevention.
